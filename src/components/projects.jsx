...
export function Projects(){
    return(<>
        ...
        <SpotlightCard className="grid grid-cols-1 text-center xl:grid-cols-2 xl:text-left m-15 gap-4 max-w-6xl justify-self-center justify-items-center" spotlightColor="rgba(255, 255, 255, 0.11)">
